...
/**
 * Native köprü — yalnızca Instagram hikaye paylaşımını karşılar.
 *
 * Sesli okuma davranışı artık bu köprüde DEĞİLDİR; tek playback sahibi
 * TtsPlayerView bileşenidir (bkz. src/components/tts-player-view.tsx).
 */
