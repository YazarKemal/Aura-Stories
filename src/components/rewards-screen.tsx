  ...
  return (
    <div className="flex flex-col gap-8 pb-24 px-4 animate-in slide-in-from-bottom-8 duration-500">
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-accent to-primary p-8 shadow-2xl shadow-primary/20">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-2xl font-headline font-black text-white">1,250</p>
            </div>
            <div className="flex flex-col gap-1">
              ...
              <p className="text-2xl font-headline font-black text-white">50</p>
            </div>
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-1.5 text-purple-200">
                <Diamond className="w-4 h-4 fill-current" />
                <span className="text-[10px] font-bold uppercase tracking-wider">Puan</span>
              </div>
              <p className="text-2xl font-headline font-black text-white">420</p>
            </div>
          </div>
      ...
      <section className="space-y-4">
        ...
        <div className="p-6 rounded-3xl bg-white border border-border/50 shadow-sm space-y-6">
          <div className="flex justify-between items-center gap-2">
            {streakDays.map((s, i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                <div className={cn(
                  "w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500",
                  s.active ? "bg-primary text-white shadow-lg shadow-primary/20 scale-110" : "bg-muted/50 text-muted-foreground",
                  s.special && !s.active && "border-2 border-dashed border-amber-400 bg-amber-50"
                )}>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <h4 className="text-sm font-bold text-accent truncate">{task.title}</h4>
                      <span className="text-[10px] font-black text-amber-500 bg-amber-50 px-2 py-0.5 rounded-full ring-1 ring-amber-200">
                        {task.reward}
                      </span>
                    </div>
      ...
      {/* Redeem Section Link */}
      <button className="flex items-center justify-between p-6 rounded-3xl bg-primary/5 border border-primary/10 group active:scale-95 transition-all">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary">
            <TrendingUp className="w-6 h-6" />
          </div>
          <div className="text-left">
            <h4 className="text-sm font-bold text-accent">Puan Mağazası</h4>
            <p className="text-[10px] text-muted-foreground">Puanlarını harika ödüllere dönüştür</p>
          </div>
        </div>
