...
export function SplashScreen() {
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-gradient-to-br from-[#1D1231] via-[#0B070F] to-[#1D1231] flex flex-col items-center justify-center animate-out fade-out duration-1000 fill-mode-forwards delay-2000">
